const careerData = [
  ...
  },
  {
    ...
    careers: ["Social Worker", "Nonprofit Manager", "Public Health Official", "Community Organizer", "Human Rights Advocate", "Environmental Scientist", "Education Consultant", "Policy Analyst", "Public Relations Specialist", "NGO Program Coordinator", "Microfinance Officer", "Sustainability Consultant", "Disaster Relief Coordinator", "Counselor", "Researcher in Social Sciences", "Youth Development Specialist", "Advocacy Director", "Gender Equality Consultant", "Urban Planner", "Corporate Social Responsibility Manager", "Volunteer Coordinator", "Public Policy Advisor", "Healthcare Administrator", "Child Welfare Specialist", "Crisis Intervention Specialist", "Cultural Heritage Specialist", "Economic Development Officer", "Environmental Activist", "Community Development Officer", "Social Impact Analyst", "Social Entrepreneur"]
