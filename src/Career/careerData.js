const careerData = [
  ...
  
  {
    ...
    careers: ["Public Relations Specialist", "Human Resources Manager", "Corporate Trainer", "Customer Service Manager", "Sales Executive", "Event Planner", "Counselor", "Mediator", "Social Worker", "Marketing Communications Specialist", "Content Strategist", "Recruiter", "Community Manager", "Relationship Manager", "Diplomat", "Negotiation Specialist", "Communication Consultant", "Customer Experience Manager", "Training and Development Manager", "Crisis Manager", "Health Educator", "Brand Ambassador", "Corporate Communications Manager", "Speech Pathologist", "Public Speaker", "Political Consultant", "Customer Success Manager", "Media Planner", "Digital Content Creator", "Engagement Specialist", "Telecommunications Specialist", "Cultural Liaison", "Family Therapist", "Advocacy Director"]
  ...
  },
  {
    ...
    careers: ["Freelance Writer", "Remote Software Developer", "Virtual Assistant", "Digital Marketing Specialist", "Graphic Designer", "Online Tutor", "Social Media Manager", "Data Analyst", "Content Creator", "SEO Specialist", "Web Developer", "Remote Project Manager", "Consultant", "Transcriptionist", "Customer Support Specialist", "E-commerce Manager", "UX/UI Designer", "Affiliate Marketer", "Online Sales Representative", "Remote Recruiter", "App Developer", "Video Editor", "Remote Researcher", "Virtual Event Coordinator", "Copywriter", "Remote Account Manager", "Remote Financial Advisor", "Data Scientist", "Online Community Manager", "Language Translator", "Remote IT Support Specialist", "Telehealth Provider", "Remote Sales Executive"]
  ...
  },
  {
    ...
    careers: ["Social Worker", "Nonprofit Manager", "Public Health Official", "Community Organizer", "Human Rights Advocate", "Environmental Scientist", "Education Consultant", "Policy Analyst", "Public Relations Specialist", "NGO Program Coordinator", "Microfinance Officer", "Sustainability Consultant", "Disaster Relief Coordinator", "Health Educator", "Counselor", "Researcher in Social Sciences", "Youth Development Specialist", "Advocacy Director", "Gender Equality Consultant", "Urban Planner", "Corporate Social Responsibility Manager", "Volunteer Coordinator", "Public Policy Advisor", "Healthcare Administrator", "Child Welfare Specialist", "Crisis Intervention Specialist", "Cultural Heritage Specialist", "Economic Development Officer", "Environmental Activist", "Community Development Officer", "Social Impact Analyst", "Social Entrepreneur"]
  ...
  },
  {
    ...
    careers: ["Innovation Manager", "Product Developer", "Futurist", "Technology Consultant", "Research and Development Engineer", "Data Scientist", "Artificial Intelligence Specialist", "Blockchain Developer", "Sustainability Consultant", "User Experience Researcher", "Digital Transformation Consultant", "Smart City Planner", "Cybersecurity Analyst", "Growth Hacker", "Virtual Reality Developer", "Robotics Engineer", "Augmented Reality Developer", "Machine Learning Engineer", "Design Thinking Consultant", "Tech Start-up Founder", "Creative Technologist", "E-commerce Innovator", "Bioinformatics Specialist", "3D Printing Specialist", "Fintech Specialist", "Cloud Solutions Architect", "Human-Computer Interaction Specialist", "IoT Solutions Architect", "Nanotechnology Researcher", "Space Technology Researcher", "Advanced Manufacturing Engineer", "Ethical Hacker", "Diversity and Inclusion Consultant"]
  ...
  },
  {
    ...
    careers: ["International Business Consultant", "Global Marketing Manager", "Diplomat", "International Relations Specialist", "Foreign Service Officer", "Global Supply Chain Manager", "Cultural Attaché", "International Trade Specialist", "Humanitarian Aid Worker", "Global Compliance Officer", "Multinational Corporation Executive", "Expatriate Consultant", "Global HR Manager", "International Development Officer", "Foreign Language Teacher", "Migration Consultant", "Global Project Manager", "Cross-Cultural Trainer", "International Policy Analyst", "Global Financial Analyst", "Trade Policy Advisor", "International Law Attorney", "NGO Project Manager", "Environmental Policy Advocate", "Global Sales Executive", "International Event Coordinator", "Corporate Social Responsibility Specialist", "Global Sourcing Manager", "World Health Organization Specialist", "UN Agency Officer", "Cross-Border Investment Advisor", "Cultural Liaison Officer"]
